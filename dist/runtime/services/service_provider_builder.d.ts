...
import type { ServiceLifetime } from "./dependency_node.js";
...
export declare class ServiceProviderBuilder implements IServiceProviderBuilder {
     ...
     */
    registerInstance<T>(target: InjectKey<T>, instance: T, lifetime?: ServiceLifetime): void;
    /**
     * Register a service type for later instantiation
     * This extracts dependencies from constructor parameters
     * @param target The service type to register
     */
    register<T>(target: ServiceType<T>, lifetime?: ServiceLifetime): void;
    registerFactory<T>(factory: (...args: any[]) => T, inject: InjectKey<unknown>[], key: InjectKey<T>, lifetime?: ServiceLifetime): void;
    registerAsyncFactory<T>(factory: (...args: any[]) => Promise<T>, inject: InjectKey<unknown>[], key: InjectKey<T>, lifetime?: ServiceLifetime): void;
    /**
