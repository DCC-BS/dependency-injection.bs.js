...
export interface IServiceProviderBuilder {
     ...
     */
    registerFactory<T>(factory: (...args: any[]) => T, inject: (string | ServiceType<unknown>)[], key: string): void;
    /**
     ...
     * @param key Unique key for the service
     * */
    registerAsyncFactory<T>(factory: (...args: any[]) => Promise<T>, inject: (string | ServiceType<unknown>)[], key: string): void;
