...
declare const module: _nuxt_schema.NuxtModule<_nuxt_schema.ModuleOptions, _nuxt_schema.ModuleOptions, false>;

export { ServiceOrchestrator, module as default };
export type { IServiceProvider, IServiceProviderBuilder };
